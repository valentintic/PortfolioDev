...
const resources = {
  en: {
    translation: {
      ...
      "Transformando ideas en soluciones digitales": "Creating digital solutions with modern technologies, a focus on best practices, and experience in real-world projects. Combining frontend, backend, and cloud to develop high-quality, end-to-end applications.",
  ...
  es: {
    translation: {
      ...
      "Transformando ideas en soluciones digitales": "Creando soluciones digitales con tecnologías modernas, enfoque en buenas prácticas y experiencia en proyectos reales. Combinando frontend, backend y cloud para desarrollar aplicaciones completas de alta calidad.",
